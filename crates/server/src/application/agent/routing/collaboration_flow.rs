...
impl AgentOrchestrationService {
    ...
    pub(in crate::application::agent) async fn close_child(
        &self,
    ...
    pub(in crate::application::agent) async fn build_child_ref_from_handle(
        &self,
        handle: &SubRunHandle,
    ) -> ChildAgentRef {
        handle.child_ref()
    ...
    pub(in crate::application::agent) async fn project_child_ref_status(
        &self,
