...
use astrcode_core::{
    LlmFinishReason, LlmOutput, ModelLimits, ResolvedRuntimeConfig, TurnTerminalKind,
};
...
impl TurnStopCause {
    ...
    pub fn terminal_kind(self, error_message: Option<&str>) -> TurnTerminalKind {
        match self {
            ...
            Self::BudgetStoppedContinuation => TurnTerminalKind::BudgetStoppedContinuation,
            Self::ContinuationLimitReached => TurnTerminalKind::ContinuationLimitReached,
