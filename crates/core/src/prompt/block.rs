...
impl BlockKind {
    pub fn default_priority(self) -> i32 {
        match self {
            BlockKind::Identity => 100,
            BlockKind::SystemPrompt => 200,
            BlockKind::Environment => 300,
            BlockKind::UserRules => 400,
            BlockKind::ProjectRules => 500,
            BlockKind::Skill => 600,
            BlockKind::FewShotExamples => 700,
        }
    }
}
