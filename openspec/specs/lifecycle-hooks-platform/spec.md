...
定义统一 hooks 平台，作为 builtin 与 external 扩展共享的生命周期总线，覆盖 input、context、before_agent_start、before_provider_request、tool_call、tool_result、turn_start、turn_end 等核心事件点。
